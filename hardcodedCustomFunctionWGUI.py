...
def run_gui():
    def start_ga():
        try:
            ...
            if choice == 1:
                ...
                objective_function = custom_function  # Select the hardcoded additional function
            else:
                messagebox.showerror("Error", "Invalid objective function choice.")
                return

            # Get the number of variables and bounds
            ...
            best_solution, best_fitness = genetic_algorithm(
                objective_function, bounds, population_size, generations, mutation_rate
            )
    ...
    bounds_entries = [tk.Entry(root) for _ in range(10)]  # Assume max 10 variables
    ...
    mutation_rate_entry.insert(0, "0.1")  # Set a default value
